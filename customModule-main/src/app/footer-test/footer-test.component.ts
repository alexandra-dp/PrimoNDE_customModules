...
const FOOTER_LABELS: Record<SupportedLang, FooterLabels> = {
  fr: {
    networkTitle: 'Réseau des bibliothèques Renouvaud',
    ...
    researchHeritageCatalog: 'Catalogue des bibliothèques de recherche et patrimoniales',
    higherEducationLibraries: 'Bibliothèques des hautes écoles',
  ...
  en: {
    ...
    researchHeritageCatalog: 'Research and Heritage libraries catalogue',
  ...
  de: {
    ...
    researchHeritageCatalog: 'Katalog der Forschungs- und Kulturerbebibliotheken',
...
@Component({
  selector: 'custom-footer-test',
  standalone: true,
  imports: [],
  templateUrl: './footer-test.component.html'
})
export class FooterTestComponent implements OnInit, OnDestroy {
